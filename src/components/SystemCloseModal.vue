<template>
  ...
  >
    <div
      ref="modalRef"
      class="bg-white rounded-lg shadow-xl resize-handle flex flex-col"
      :style="{
        position: 'fixed',
    ...
    >
      <div class="bg-white rounded-lg shadow-2xl p-8 flex flex-col items-center gap-4">
        ...
        ></div>
        <p class="text-2xl font-semibold text-gray-700">Processing...</p>
...
const submitForm = () => {
  // Show processing first, then show warning after 3 seconds
  showWarning.value = false
  ...
  processingTimer = setTimeout(() => {
    ...
    warningMessageInput.value = 'SYSTEM CLOSED. TRY AGAIN TOMORROW.'
